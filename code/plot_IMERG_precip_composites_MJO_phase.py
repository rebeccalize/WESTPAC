...
for MJO in [1,2,3,4,5,6,7,8]: #7

	#infile = "gpm-imerg.precip_composite.daily_rainfall_bias_from_daily_climatology.MJO_phase_"+str(MJO)+".2001-2019*grid.txt"
	
	infile = "gpm-imerg.WINTER_Oct-March.precip_composite.daily_rainfall_bias_from_daily_climatology.MJO_phase_"+str(MJO)+".2001-2019*.txt"
	...
	outfile = "gpm-imerg.WINTER_Oct-March.mean_daily_precip_bias_from_daily_climatology_composite.MJO_phase_"+str(MJO)+".2001-2019.mmperday.TRMM_grid.png"
	...
	infile_consistency = "gpm-imerg.WINTER_Oct-March.CONSISTENCY.precip_composite.daily_rainfall_bias_from_daily_climatology.MJO_phase_"+str(MJO)+".2001-2019*grid_v2.txt"
	...
	outfile_consistency = "gpm-imerg.WINTER_Oct-March.mean_daily_precip_bias_from_daily_climatology_composite.CONSISTENCY.MJO_phase_"+str(MJO)+".2001-2019.mmperday.TRMM_grid.png"
