...
def compute_rainfall_anomalies(year_array, MJO_phase): #1,2,3,4,5,6,7,8

	MJO_file = "/gws/nopw/j04/klingaman/datasets/MJO_INDICES/MJO_phase"+str(MJO_phase)+".jan-dec_dmeans_ts.1979-2019.nc"
	...
	np.savetxt("gpm-imerg.precip_composite.daily_rainfall_bias_from_daily_climatology.MJO_phase_"+str(MJO_phase)+"."+enso_label+"."+str(no_days).zfill(4)+"-days.txt",  imerg_bias_comp[:,:], '%.4f')
	...
	np.savetxt("gpm-imerg.CONSISTENCY.precip_composite.daily_rainfall_bias_from_daily_climatology.MJO_phase_"+str(MJO_phase)+"."+enso_label+"."+str(no_days).zfill(4)+"-days.txt",  consistency[:,:], '%.4f')
...
#run for phase pairs 45, 67, 81, 23
#compute_rainfall_anomalies(ENyears, 12)
#compute_rainfall_anomalies(ENyears, 34)
compute_rainfall_anomalies(ENyears, 56)
#compute_rainfall_anomalies(ENyears, 78)

#compute_rainfall_anomalies(LNyears, 12)
#compute_rainfall_anomalies(LNyears, 34)
#compute_rainfall_anomalies(LNyears, 56)
#compute_rainfall_anomalies(LNyears, 78)
