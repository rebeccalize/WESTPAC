...
for BSISO in [1,2,3,4,5,6,7,8]: #2,6
	
	infile="gpm-imerg.precip_composite.percentage_of_days_exceeding_95th_percentile_of_SUMMER_climatology.BSISO_phase_"+str(BSISO)+".2001-2019.*.April-Sept.MONTHLY_percentiles.txt"
	...
	no_days = infilename[118:122] #get the number of days out of the filename string

	print no_days

	outfile = "gpm-imerg.SUMMER_April-Sept.probability_of_extreme_rainfall.percentage_of_days_exceeding_95th_percentile_of_climatology.BSISO_phase_"+str(BSISO)+".2001-2019.TRMM_grid.MONTHLY_percentiles.png"
