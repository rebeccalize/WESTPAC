...
for ENSO in ['elnino','lanina']: #2,6

	infile = "gpm-imerg.precip_composite.daily_rainfall_bias_from_daily_climatology."+ENSO+"_years_1.0_ONI_threshold.*.txt"
	...
	no_days = infilename[101:105] #get the number of days out of the filename string
	print no_days
	
	outfile = "gpm-imerg.mean_daily_precip_bias_from_daily_climatology_composite."+ENSO+"_years_1.0_ONI_threshold.2001-2019.mmperday.using_precipitationCal_and_TRMM_grid_v2.png"
	...
	infile_consistency = "gpm-imerg.CONSISTENCY.precip_composite.daily_rainfall_bias_from_daily_climatology."+ENSO+"_years_1.0_ONI_threshold*.txt"
	...
	outfile_consistency = "gpm-imerg.mean_daily_precip_bias_from_daily_climatology_composite.CONSISTENCY."+ENSO+"_years_1.0_ONI_threshold.2001-2019.mmperday.using_precipitationCal_and_TRMM_grid_v2.png"
